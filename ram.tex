...
Za tvrdnju~\ref{case:in}, pogledajmo redom učinke pojedinih makro-instrukcija iz definicije~\ref{def:funmakro}.
	...
	Nakon prve instrukcije \textsc{mmove}, prvih $b$ registara bit će resetirano, a njihove stare vrijednosti $r_0,r_1,\dots,r_{b-1}$ bit će u idućih $b$ registara. Posebno, u $\reg{b+j_t}\!$ nalazit će se $r_{j_t}$, za sve $t\in[1\dd k]$.
