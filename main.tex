...
\renewcommand{\listtheoremname}{Popis definicija, teorema, primjera, lema, napomena i korolara}
...
\newcommand{\eq}{=}
\newcommand{\dd}{\mathbin{\cdot\cdot}}
...
\definecolor{title-gray}{gray}{0.1}
