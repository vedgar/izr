...
\definecolor{title-gray}{gray}{0.1} \definecolor{dark-blue}{HTML}{000055}
\definecolor{dark-red}{HTML}{550000} \definecolor{brown}{HTML}{6F5A21}

\begin{document}
%\tracingall
\frontmatter
\titlehead{\centering{\Huge{\color{title-gray}\textup{\MakeUppercase{c o m p u t o n o m i c o n}}}}\vspace{1cm}
