...
Postoji fragment Turingovog stroja koji prevodi konfiguraciju $(q_3,\dulj w+1,\t\$\bl^{\dulj w}\t\#uv\t\$\bl\ldots)$, gdje je $u\in(B^m)^*$ te $v\in\Sigma_0^*$, u konfiguraciju $(l_{\bl},\dulj v,v\bl\ldots)$.
\end{lema}
\noindent\begin{gather*}
    \SwapAboveDisplaySkip
...
%Stigli smo do završnog stanja $l_{\bl}$. Time smo napokon završili konstrukciju Turingovog stroja $\mathcal T_0$ i sve je spremno za dokaz "obrata" teorema~\ref{tm:tikp}.
