...
\begin{quote}
    ...
    Traktenbrot: ``\!\emph{This is the way the miracle occurred: the essence of a process that can be carried out by purely mechanical means was understood and incarnated in precise mathematical definitions.}''
\end{quote}
