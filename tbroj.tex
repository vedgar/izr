...
\begin{gather}
    \SwapAboveDisplaySkip
\label{eq:d88j}
    \delta(m_{\t\$},\alpha):=(q_\mathit{true},\alpha,1)\text{, za sve }\alpha\in\Sigma\text,\\
\label{eq:d89j}
    \delta(m_{\t\$},\t\$):=(q_\mathit{false},\bl,-1)\text.
\end{gather}
...
Neka je $k\in\N_+$ te $f^k$ brojevna funkcija. Za jezičnu funkciju $\beta f$ zadanu s \begin{equation}\label{eq:betaf}
