...
definiramo \emph{kod programa} $P$ kao
    $\kprog P:=\N\mathscr Pro\!g(P):=\langle\kins{I_0\!},\kins{I_1\!},\dotsc,\kins{I_{n-1}\!}\rangle$.
\end{definicija}
...
\begin{lema}[{name=[primitivna rekurzivnost slike kodiranja RAM-programa]}]
    Slika kodiranja RAM-programa, $\f{Prog}^1:=\,\im{\N\mathscr Pro\!g}=\{\kprog P\mid P\in\mathscr Prog\}$, primitivno je rekurzivna.
\end{lema}
\begin{proof}
