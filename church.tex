...
Argumentima potrebnim za dokaz Churchovog teorema već smo se poprilično približili dokazu Gödelovog prvog teorema, u formulaciji Tarskog: \textbf{Postoji istinita rečenica na prirodnim brojevima, nedokaziva u PA\@}. Za potpuni dokaz trebalo bi razraditi još mnogo tehničkih detalja, ali pogledajmo samo osnovnu ideju.
...
\begin{propozicija}[{name=[istinitost Gödelovog skupa rečenica u $\mathfrak N$]}]\label{pp:NvdGo}
