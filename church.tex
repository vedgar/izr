...
\emph{Problem valjanosti} pita: za zadanu formulu $\phi\in F1$, je li $\phi\in Valid$?

\emph{Problem zaključivanja} pita: za zadane $\phi_1,\phi_2,\dotsc,\phi_k,\phi\in F1$, je li $\phi$ logička posljedica skupa $\{\phi_1,\dotsc,\phi_k\}$?
\end{definicija}
