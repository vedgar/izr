...
\usepackage{hyperxmp} \usepackage{hyperref} \usepackage{xcolor} \hypersetup{
    unicode, colorlinks, linkcolor={red!50!black},
    citecolor={blue!50!black}, urlcolor={blue!80!black},
    pdftitle={Komputonomikon},
    pdfsubtitle={Izračunljivost za računarce},
    pdfauthor={Vedran Čačić (Veky)},
    pdfauthortitle={dr.sc.},
    pdfcaptionwriter={Vedran Čačić},
    pdfcontactaddress={PMF-MO, Bijenička 30},
    pdfcontactcity={Zagreb},
    pdfcontactcountry={HR},
    pdfcontactemail={veky@math.hr},
    pdfcontactphone={+385-1/5585-423},
    pdfcontactpostcode={10000},
    pdfcontacturl={http://web.math.hr/~veky},
    pdfcopyright={CC0 Javno dobro},
    pdflicenseurl={https://creativecommons.org/publicdomain/zero/1.0/deed.hr},
    pdflang={hr},
    pdfurl={https://web.math.pmf.unizg.hr/~veky/izr/Komputonomikon.pdf},
    baseurl={https://web.math.pmf.unizg.hr/~veky/izr/},
    pdfapart={1},
    pdfaconformance={B},
    pdfsubject={izračunljivost},
    pdfkeywords={RAM-stroj, Turingov stroj, teorija rekurzije, neodlučivost}
}
...
\declaretheorem[parent=chapter,style=kni]{lema}
...
\renewcommand\cftchapafterpnum{\vskip 14pt} %set space after each Chapter in the Table of Contents
\renewcommand\cftsecafterpnum{\vskip 8pt}  %set space after each Section in the Table of Contents
\date{\today} \maketitle \setcounter{tocdepth}{1} \tableofcontents
